...
class Movie_dataList {
	...
	public static void main(String[] args) {
		...
		List<Movie_Details> movie = Arrays.asList(new Movie_Details("3idiots", "Amir", "Virus", "Education"),
				new Movie_Details("Thor:Ragnarok", "Thor", "Hela", "Action"),
				new Movie_Details("Maari", "Dhanush", "Tovino", "Entertainment"));
